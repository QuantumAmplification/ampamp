...
class PublishabilityConfig:
    ...
    def summary(self) -> str:
        ...
        return (
            ...
            f"validation_log={self.structured_log_path or 'disabled'}"
        )
    ...
    def _validate_one(self, record: _RecordedCircuit, index: int) -> None:
        ...
        try:
            ...
            if AerSimulator is None or SamplerV2 is None or transpile is None:
                ...
                self._append_log({**base_record, "status": "backend_unavailable"})
                return
            ...
            self._append_log({**base_record, "status": "error", "error": str(exc)})
