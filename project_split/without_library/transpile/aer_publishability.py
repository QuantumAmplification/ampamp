...
try:
    from entanglement_monitor import EntanglementConfig, profile_circuit_entanglement
except Exception:  # pragma: no cover
...
class PublishabilityConfig:
    ...
    entanglement_max_qubits: int = 12
    ...
    def summary(self) -> str:
        ...
        entanglement = (
            "enabled("
            f"limit={self.entanglement_max_qubits}, snapshots={self.entanglement_max_snapshots}, "
        ...
        states = (
            "enabled("
            f"limit={self.state_max_qubits}, top_k={self.state_top_k}, "
        ...
        return (
            ...
            f"mode={self.mode} ({state}), validation_limit={self.max_qubits}, shots={self.shots}, "
            ...
            f"validation_log={self.structured_log_path or 'disabled'}, entanglement={entanglement}, states={states}"
        )
...
def parse_publishability_cli(
    ...
    *,
    ...
    default_entanglement_max_qubits: int = 12,
    default_entanglement_max_snapshots: int = 64,
    default_state_max_qubits: int = 8,
    ...
    def _profile_entanglement(self, circuit: "QuantumCircuit") -> dict[str, Any]:
        ...
        if EntanglementConfig is None or profile_circuit_entanglement is None:
            return {
                ...
                "entanglement_error": "entanglement_monitor import failed",
            }
        try:
    ...
    def _validate_one(self, record: _RecordedCircuit, index: int) -> None:
        ...
        try:
            ...
            if circuit.num_qubits > self.config.max_qubits:
                ...
                if entanglement_status == "ok":
                    ...
                    print(
                        ...
                        f"(qubits={circuit.num_qubits} > entanglement_limit={self.config.entanglement_max_qubits})."
                    )
                if state_status == "ok":
                    print(
                    ...
                    print(
                        ...
                        f"(qubits={circuit.num_qubits} > state_limit={self.config.state_max_qubits})."
                    )
            ...
            if AerSimulator is None or SamplerV2 is None or transpile is None:
                ...
                self._append_log({**base_record, "status": "backend_unavailable", **entanglement_payload})
                return

            backend_kwargs = {"seed_simulator": self.config.seed}
            ...
            sampler = SamplerV2(
                ...
                seed=self.config.seed,
                options=sampler_options or None,
            )
