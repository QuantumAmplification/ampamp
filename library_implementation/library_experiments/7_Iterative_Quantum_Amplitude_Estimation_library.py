...
to avoid rewriting standard logical components.
"""
...
class IQAELab:
    ...
    Wrapped around the ampamp library.
    """
...
def run_full_analysis(
    ...
    max_k: int = 16,
    shots: int = 100,
    save_plot: str = "iqae_geometric_evidence_library.png",
    show_plot: bool = False
):
    print("\n" + "=" * 70)
    print("ITERATIVE QUANTUM AMPLITUDE ESTIMATION (IQAE/MLAE) LABORATORY (LIBRARY BACKED)")
    print("=" * 70)
    ...
    plt.title("MLAE Likelihood Landscape (Library Backed)")
    plt.xlabel("Theta")
...
if __name__ == "__main__":
    start_one_click_session(__file__, figure_prefix="iqae_library")
