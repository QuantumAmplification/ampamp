...
def run_scenario_a(n_qubits=5, good_indices=[10], max_i=4):
    ...
    Evaluates how the depth explodes as IQAE schedules k_i = 2^i.
    """
    print("\n" + "=" * 70)
    print("SCENARIO A: EXPONENTIAL DEPTH BLOWUP IN IQAE")
    print("=" * 70)
...
def run_scenario_b(n_qubits=5, k=4):
    ...
    """
    print("\n" + "=" * 70)
    print("SCENARIO B: ROUTING PENALTY FOR HIGH-k CIRCUITS")
    print("=" * 70)
...
def run_scenario_c(n_qubits=4, max_i=3):
    ...
    """
    print("\n" + "=" * 70)
    print("SCENARIO C: NOISE DEGRADATION OVER IQAE SCHEDULE")
    print("=" * 70)
...
if __name__ == "__main__":
    ...
    print("Starting IQAE Transpilation Benchmark...")
